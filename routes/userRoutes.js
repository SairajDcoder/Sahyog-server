...
// GET /api/users/coordinators - List all coordinators (Admin/Org/Coordinator)
router.get('/coordinators', verifyToken, checkRole(['org:admin', 'organization', 'coordinator']), listCoordinators);
